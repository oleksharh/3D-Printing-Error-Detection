...
class ParametersClassifier(pl.LightningModule):
    def __init__(
        ...
        # Train Metrics
        self.train_acc = Accuracy(**metric_conf)
        self.train_acc0 = Accuracy(**metric_conf)
        self.train_acc1 = Accuracy(**metric_conf)
        self.train_acc2 = Accuracy(**metric_conf)
        self.train_acc3 = Accuracy(**metric_conf)

        # Val Metrics
        self.val_acc = Accuracy(**metric_conf)
        self.val_acc0 = Accuracy(**metric_conf)
        self.val_acc1 = Accuracy(**metric_conf)
        self.val_acc2 = Accuracy(**metric_conf)
        self.val_acc3 = Accuracy(**metric_conf)

        # Test Metrics
        self.test_acc = Accuracy(**metric_conf)
        self.test_acc0 = Accuracy(**metric_conf)
        self.test_acc1 = Accuracy(**metric_conf)
        self.test_acc2 = Accuracy(**metric_conf)
        self.test_acc3 = Accuracy(**metric_conf)
    ...
    def test_step(self, test_batch, batch_idx):
        ...
        self.test_acc0(preds0, y[0])
        self.test_acc1(preds1, y[1])
        self.test_acc2(preds2, y[2])
        self.test_acc3(preds3, y[3])

        self.log("test_acc_flow", self.test_acc0, on_epoch=True)
        self.log("test_acc_speed", self.test_acc1, on_epoch=True)
        self.log("test_acc_z", self.test_acc2, on_epoch=True)
        self.log("test_acc_hotend", self.test_acc3, on_epoch=True)
    ...
    def on_test_epoch_end(self):
        ...
        # 2. Concatenate (dim=1 matches your stack(preds0, preds1, etc) logic)
